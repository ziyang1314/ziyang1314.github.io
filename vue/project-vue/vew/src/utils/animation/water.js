...
var rippleEffect = function (t) {
    ...
    if (!a) {
        document.body.insertAdjacentHTML("afterbegin",
            ...
            '"><feImage xlink:href="' + dataDisplacementImg +
            '" x="0" y="0" width="'+width+'" height="'+height+'" result="ripple"></feImage><feDisplacementMap xChannelSelector="G" yChannelSelector="R" color-interpolation-filters="sRGB" in="SourceGraphic" in2="ripple" scale="0"></feDisplacementMap><feComposite operator="in" in2="ripple"></feComposite><feComposite in2="SourceGraphic"></feComposite></filter></defs></svg>'
        )
    }
    ...
    t.addEventListener("click", function (e) { 
        ...
        o = Math.animation(0, h, w, function (e, r) {
            i.setAttribute("x", s - e / 2);
            i.setAttribute("y", c - e / 2);
